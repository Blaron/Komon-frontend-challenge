...
export default function New() {
  ...
  const lastPost =
    settings.conexiones[0].twitter.post[
      settings.conexiones[0].twitter.post.length - 1
    ].id;
  ...
  const { createPostTwitter } = useConnectData();
  ...
  return (
    <main className="w-full min-h-screen">
      <div className="mb-3 flex w-1/5 items-center justify-center">
        <Link href="/socialMedia/twitter" className="flex items-center">
          <svg

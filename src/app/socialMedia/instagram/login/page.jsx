    ...
    <main className="w-full min-h-screen">
      ...
      <div className="md:flex md:justify-center">
        <div className="relative max-w-7xl overflow-hidden px-6 pt-8">
          ...
          <div className="mt-10">
            ...
            />
            <button className="mt-4 mx-2 w-11/12 h-8 md:h-12 focus:ring-4 group flex items-center justify-center p-0.7 text-center font-medium focus:z-10 rounded-lg cursor-pointer bg-transparent text-black border border-solid border-black">
              Connect
            </button>
      ...
      <div className="md:flex md:justify-center mt-10">
        <p>
          ...
          status to maintain the session.
        </p>
      </div>
    </main>
  );
